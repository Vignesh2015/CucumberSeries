...
public class ContactUsSteps {
	...
	public void user_fills_the_form_from_given_sheetname_and_rownumber(String sheetName, Integer rowNumber) throws InvalidFormatException, IOException {
		...
		List<Map<String,String>> testData = excelReader.getData("E:\\Current Documents\\Desktop\\automation.xlsx", sheetName);
		...
		contactUsPage.fillContactUsForm(subjectHeading, email, orderRef, message);
	...
	public void it_shows_a_successful_message(String expectedSuccMessage) {
	 
		String actualSuccMessage = contactUsPage.getSuccessMessg();
		Assert.assertEquals(actualSuccMessage, expectedSuccMessage);
	}
